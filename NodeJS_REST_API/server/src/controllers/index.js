...
import TemplateControllers from "./TemplateControllers.js";
import MessagesControllers from "./MessageControllers.js";
...
export const productListController = new ProductListControllers(
  productListService
);
export const templateControllers = new TemplateControllers();
